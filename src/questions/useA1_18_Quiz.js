...
function useA1_18_Quiz(componentType) {
    ...
    if (componentType === 'A1_18_Quiz_1') {
        var answerCheck = ['나비 자세', '비둘기 자세', '굴렁쇠 자세', '아치 자세'];
    } else if (componentType === 'A1_18_Quiz_2') {
        var answerCheck = ['앉은 자세', '앉은 자세', '누운 자세', '누운 자세'];
    } else if (componentType === 'A1_18_Quiz_3') {
